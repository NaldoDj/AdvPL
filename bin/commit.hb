...
#define _COMMIT_HBROOT_  hb_PathNormalize( hb_DirSepToOS( "C:\GitHub\AdvPL\" ) )  /* must end with dirsep */
...
PROCEDURE Main( cParam1 )
   ...
   InstallHook( "pre-commit"        , hb_StrFormat( "exec ../core/bin/win/mingw/hbrun bin/%1$s.hb --check-only", hb_FNameName( hb_ProgName() ) ) )
// InstallHook( "prepare-commit-msg", hb_StrFormat( "exec ../core/bin/win/mingw/hbrun bin/%1$s.hb $1 --prepare-commit", hb_FNameName( hb_ProgName() ) )
